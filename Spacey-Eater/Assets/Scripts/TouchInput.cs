...
{
    public float changePerClick = 1f;
            ...
            for (int i = 0; i < nbTouches; i++)
            {
                ...
                if (touch.phase == TouchPhase.Began)
                {
                    ...
                    if (Physics.Raycast(screenRay, out hit))
                    {
                        ...
                        CircleCollider2D circleCollider = hit.collider.gameObject.GetComponent<CircleCollider2D>();
                        circleCollider.transform.localScale -= new Vector3 (changePerClick, changePerClick, 0f);
                    }
                }
            }
        }
